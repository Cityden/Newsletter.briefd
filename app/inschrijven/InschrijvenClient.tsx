...
// locale komt van de server (zie app/inschrijven/page.tsx, dat de cookie leest
// via cookies()). Eerder startte deze pagina client-side op 'nl' en corrigeerde
// pas na mount — de eerste HTML was daardoor altijd Nederlands, ook op
// brieft.online.
export default function InschrijvenClient({ locale }: { locale: Locale }) {
